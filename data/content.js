...
const CONTENT = {
  ...
  진지: [
    ...
    { id: 'jj_mandela', quote: '나는 절대 지지 않는다, 이기거나 배울 뿐이다', source: '넬슨 만델라', person: { ko: '넬슨 만델라', en: 'Nelson Mandela' }, moodTags: ['실패좌절', '기분나쁨', '포기도전'] },
    { id: 'jj_ali', quote: '불가능, 그것은 사실이 아니라 의견일 뿐이다', source: '무하마드 알리', person: { ko: '무하마드 알리', en: 'Muhammad Ali' }, moodTags: ['포기도전', '자신감자부심'] },
    { id: 'jj_jordan', quote: '나는 실패를 받아들일 수 있다, 그러나 시도하지 않는 것은 받아들일 수 없다', source: '마이클 조던', person: { ko: '마이클 조던', en: 'Michael Jordan' }, moodTags: ['실패좌절', '스트레스짜증', '포기도전'] },
    { id: 'jj_maya', quote: '사람들은 당신이 한 말은 잊어도, 당신이 준 느낌은 잊지 않는다', source: '마야 안젤루', person: { ko: '마야 안젤루', en: 'Maya Angelou' }, moodTags: ['관계위로', '기분나쁨', '그리움', '외로움협업'] },
    { id: 'jj_seneca', quote: '우리를 화나게 하는 것보다, 화 자체가 우리를 더 다치게 한다', source: '세네카', person: { ko: '세네카', en: 'Seneca the Younger' }, moodTags: ['분노', '억울함', '스트레스짜증'] },
    { id: 'jj_twain', quote: '20년 후 당신은 한 일보다 하지 않은 일에 더 실망할 것이다', source: '마크 트웨인', person: { ko: '마크 트웨인', en: 'Mark Twain' }, moodTags: ['상실감실망', '죄책감후회', '포기도전'] },
  ],
  철학: [
    ...
    { id: 'ph_aristotle', quote: '우리는 반복적으로 행하는 것으로 만들어진다, 탁월함은 행위가 아니라 습관이다', source: '아리스토텔레스', person: { ko: '아리스토텔레스', en: 'Aristotle' }, moodTags: ['습관노력', '포기도전'] },
    { id: 'ph_nietzsche', quote: '나를 죽이지 못하는 고통은 나를 더 강하게 만든다', source: '프리드리히 니체', person: { ko: '프리드리히 니체', en: 'Friedrich Nietzsche' }, moodTags: ['스트레스짜증', '실패좌절', '기분나쁨', '무기력번아웃', '두려움공포'] },
    { id: 'ph_aurelius', quote: '우리의 삶은 우리의 생각이 만들어가는 것이다', source: '마르쿠스 아우렐리우스', person: { ko: '마르쿠스 아우렐리우스', en: 'Marcus Aurelius' }, moodTags: ['생각마음', '기분나쁨', '허무함', '불안긴장'] },
    { id: 'ph_epictetus', quote: '사람을 괴롭히는 것은 사건 자체가 아니라, 그 사건에 대한 우리의 판단이다', source: '에픽테토스', person: { ko: '에픽테토스', en: 'Epictetus' }, moodTags: ['당황난처', '초조함', '창피부끄러움', '억울함', '스트레스짜증'] },
    { id: 'ph_seneca2', quote: '가장 큰 손해는 시간을 낭비하는 것이다, 하지만 이는 눈에 보이지 않아 알아채기 어렵다', source: '세네카', person: { ko: '세네카', en: 'Seneca the Younger' }, moodTags: ['혐오지겨움', '지루함', '시간고민', '무기력번아웃'] },
  ],
};
